...
<head>
	...
	<header>
		...
		<!-- logo -->
			<div class="three col">
				<a href="<?php echo home_url(); ?>" class="logo" title="Courtney Mclean Graphic Design Logo"><img src="<?php bloginfo('template_directory'); ?>/images/courtneymclean_logo.png" class="scale-with-grid" alt="" /></a>
			</div>
